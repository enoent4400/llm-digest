...
export interface PreferencesFormData {
  defaultFormat: 'executive-summary' | 'action-plan' | 'faq' | 'mind-map';
  notifications: {
...
export const preferencesSchema = z.object({
  defaultFormat: z.enum(['executive-summary', 'action-plan', 'faq', 'mind-map']),
...
export interface FilterFormData {
  ...
  format: 'all' | 'executive-summary' | 'action-plan' | 'faq' | 'mind-map';
  dateFrom?: string;
  dateTo?: string;
...
export const filterFormSchema = z.object({
  ...
  format: z.enum(['all', 'executive-summary', 'action-plan', 'faq', 'mind-map']),
